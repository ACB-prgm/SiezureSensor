...
def api_status(db: OrmSession = Depends(get_db)) -> dict[str, object]:
  ...
  return {
    ...
    "latest_reset_info": latest_batch.reset_info if latest_batch else None,
    "latest_uptime_ms": latest_batch.uptime_ms if latest_batch else None,
    ...
    "latest_min_free_heap": latest_batch.min_free_heap if latest_batch else None,
    "latest_heap_fragmentation": latest_batch.heap_fragmentation if latest_batch else None,
    ...
    "latest_last_http_duration_ms": latest_batch.last_http_duration_ms if latest_batch else None,
    "latest_last_http_status": latest_batch.last_http_status if latest_batch else None,
    "latest_consecutive_upload_failures": latest_batch.consecutive_upload_failures if latest_batch else None,
    "latest_wifi_disconnect_count": latest_batch.wifi_disconnect_count if latest_batch else None,
    "latest_session": (
      {
