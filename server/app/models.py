...
class Batch(Base):
  ...
  reset_info = Column(Text, nullable=True)
  ...
  heap_fragmentation = Column(Integer, nullable=True)
  ...
  last_http_duration_ms = Column(Integer, nullable=True)
  last_http_status = Column(Integer, nullable=True)
  consecutive_upload_failures = Column(Integer, nullable=True)
